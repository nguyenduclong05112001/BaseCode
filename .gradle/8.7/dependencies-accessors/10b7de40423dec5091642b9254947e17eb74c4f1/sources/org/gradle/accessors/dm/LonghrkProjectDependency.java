...
@NonNullApi
public class LonghrkProjectDependency extends DelegatingProjectDependency {

    @Inject
    public LonghrkProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {

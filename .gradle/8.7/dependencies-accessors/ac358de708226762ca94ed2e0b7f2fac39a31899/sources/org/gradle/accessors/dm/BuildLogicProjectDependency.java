...
public class BuildLogicProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":convention"
     */
    public ConventionProjectDependency getConvention() { return new ConventionProjectDependency(getFactory(), create(":convention")); }

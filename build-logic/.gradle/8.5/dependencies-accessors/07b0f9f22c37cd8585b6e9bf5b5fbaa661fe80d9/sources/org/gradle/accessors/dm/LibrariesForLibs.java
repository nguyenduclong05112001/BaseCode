...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxBrowser'.
             * This dependency was declared in catalog libs.versions.toml
             */
         ...
         * with versionRef 'androidxMetrics'.
             * This dependency was declared in catalog libs.versions.toml
             */
         ...
         * with versionRef 'androidxProfileinstaller'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxBenchmarkLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxMacroBenchmark'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeFoundationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with versionRef 'androidxComposeAlpha'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with versionRef 'androidxComposeMaterial3AdaptiveNavigationSuite'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeMaterial3AdaptiveLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with versionRef 'androidxComposeMaterial3Adaptive'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
    ...
    public static class AndroidxComposeRuntimeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with versionRef 'androidxComposeRuntimeTracing'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxCoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxCoreSplashscreen'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxHiltNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxHiltNavigationCompose'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() {
    ...
    public static class AndroidxNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxNavigation'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() {
    ...
    public static class AndroidxTracingLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxTracing'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
    ...
    public static class AndroidxWindowLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxWindowManager'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
    ...
    public static class GoogleOssLicensesLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with versionRef 'googleOssPlugin'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class RetrofitKotlinLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'retrofitKotlinxSerializationJson'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidGradlePlugin (8.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidTools (31.4.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxComposeAlpha (1.7.0-beta01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxComposeBom (2024.02.02)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxComposeMaterial3Adaptive (1.0.0-beta01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxComposeMaterial3AdaptiveNavigationSuite (1.3.0-beta01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxLifecycle (2.8.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxMacroBenchmark (1.2.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxNavigation (2.8.0-alpha06)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxUiAutomator (2.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxWindowManager (1.3.0-alpha03)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: dependencyGuard (0.5.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: moduleGraph (2.5.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: roborazzi (1.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: truth (1.4.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeBundleAccessors extends BundleFactory {
        ...
        /**
         * Returns the group of bundles at bundles.androidx.compose.ui
         */
    ...
    public static class AndroidxComposeUiBundleAccessors extends BundleFactory {
        ...
        public AndroidxComposeUiBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

            /**
             * Creates a dependency bundle provider for androidx.compose.ui.test which is an aggregate for the following dependencies:
             * <ul>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final LonghrkPluginAccessors paccForLonghrkPluginAccessors = new LonghrkPluginAccessors(providers, config);
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for dependencyGuard to the plugin id 'com.dropbox.dependency-guard'
             * with versionRef 'dependencyGuard'.
             * This plugin was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of plugins at plugins.longhrk
         */
        public LonghrkPluginAccessors getLonghrk() {
            return paccForLonghrkPluginAccessors;
        }
    ...
    public static class LonghrkPluginAccessors extends PluginFactory {
        private final LonghrkAndroidPluginAccessors paccForLonghrkAndroidPluginAccessors = new LonghrkAndroidPluginAccessors(providers, config);
        private final LonghrkJvmPluginAccessors paccForLonghrkJvmPluginAccessors = new LonghrkJvmPluginAccessors(providers, config);

        public LonghrkPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for longhrk.hilt to the plugin id 'longhrk.hilt'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getHilt() { return createPlugin("longhrk.hilt"); }

        /**
         * Returns the group of plugins at plugins.longhrk.android
         */
        public LonghrkAndroidPluginAccessors getAndroid() {
            return paccForLonghrkAndroidPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.longhrk.jvm
         */
        public LonghrkJvmPluginAccessors getJvm() {
            return paccForLonghrkJvmPluginAccessors;
        }

    }

    public static class LonghrkAndroidPluginAccessors extends PluginFactory {
        private final LonghrkAndroidApplicationPluginAccessors paccForLonghrkAndroidApplicationPluginAccessors = new LonghrkAndroidApplicationPluginAccessors(providers, config);
        private final LonghrkAndroidLibraryPluginAccessors paccForLonghrkAndroidLibraryPluginAccessors = new LonghrkAndroidLibraryPluginAccessors(providers, config);

        public LonghrkAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for longhrk.android.feature to the plugin id 'longhrk.android.feature'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFeature() { return createPlugin("longhrk.android.feature"); }

            /**
             * Creates a plugin provider for longhrk.android.lint to the plugin id 'longhrk.android.lint'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getLint() { return createPlugin("longhrk.android.lint"); }

            /**
             * Creates a plugin provider for longhrk.android.room to the plugin id 'longhrk.android.room'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getRoom() { return createPlugin("longhrk.android.room"); }

            /**
             * Creates a plugin provider for longhrk.android.test to the plugin id 'longhrk.android.test'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getTest() { return createPlugin("longhrk.android.test"); }

        /**
         * Returns the group of plugins at plugins.longhrk.android.application
         */
        public LonghrkAndroidApplicationPluginAccessors getApplication() {
            return paccForLonghrkAndroidApplicationPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.longhrk.android.library
         */
        public LonghrkAndroidLibraryPluginAccessors getLibrary() {
            return paccForLonghrkAndroidLibraryPluginAccessors;
        }

    }

    public static class LonghrkAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public LonghrkAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for longhrk.android.application to the plugin id 'longhrk.android.application'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("longhrk.android.application"); }

            /**
             * Creates a plugin provider for longhrk.android.application.compose to the plugin id 'longhrk.android.application.compose'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("longhrk.android.application.compose"); }

            /**
             * Creates a plugin provider for longhrk.android.application.firebase to the plugin id 'longhrk.android.application.firebase'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFirebase() { return createPlugin("longhrk.android.application.firebase"); }

            /**
             * Creates a plugin provider for longhrk.android.application.flavors to the plugin id 'longhrk.android.application.flavors'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFlavors() { return createPlugin("longhrk.android.application.flavors"); }

            /**
             * Creates a plugin provider for longhrk.android.application.jacoco to the plugin id 'longhrk.android.application.jacoco'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getJacoco() { return createPlugin("longhrk.android.application.jacoco"); }

    }

    public static class LonghrkAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public LonghrkAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for longhrk.android.library to the plugin id 'longhrk.android.library'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("longhrk.android.library"); }

            /**
             * Creates a plugin provider for longhrk.android.library.compose to the plugin id 'longhrk.android.library.compose'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("longhrk.android.library.compose"); }

            /**
             * Creates a plugin provider for longhrk.android.library.jacoco to the plugin id 'longhrk.android.library.jacoco'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getJacoco() { return createPlugin("longhrk.android.library.jacoco"); }

    }

    public static class LonghrkJvmPluginAccessors extends PluginFactory {

        public LonghrkJvmPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for longhrk.jvm.library to the plugin id 'longhrk.jvm.library'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getLibrary() { return createPlugin("longhrk.jvm.library"); }
    ...
    public static class ModulePluginAccessors extends PluginFactory {
        ...
        public ModulePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for module.graph to the plugin id 'com.jraska.module.graph.assertion'
             * with versionRef 'moduleGraph'.
             * This plugin was declared in catalog libs.versions.toml
             */

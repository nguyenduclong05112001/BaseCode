...
export JAVA_HOME="$(cd $DIR/../longhrk-prebuilts/jdk17/linux && pwd )"
...
cp $DIR/../longhrk-prebuilts/google-services.json $DIR/app

echo "Copying local.properties"
cp $DIR/../longhrk-prebuilts/local.properties $DIR

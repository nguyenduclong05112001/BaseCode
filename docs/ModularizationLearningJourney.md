...
the [`build-logic` folder](https://github.com/android/longhrk/tree/main/build-logic).
...
* **High cohesion** - A module should comprise a collection of code that acts as a system. It should
  ...
  example,
  the [`core:network` module](https://github.com/android/longhrk/tree/main/core/network) in Now
...
<table>
  ...
  <tr>
   ...
   Examples include:<br>
   <ul>
      <li><a href="https://github.com/android/longhrk/tree/main/feature/topic"><code>feature:topic</code></a> displays information about a topic on the TopicScreen.</li>
      <li><a href="https://github.com/android/longhrk/tree/main/feature/foryou"><code>feature:foryou</code></a> which displays the user's news feed, and onboarding during first run, on the For You screen.</li>
      </ul>
   </td>
